...
public class Application2 {
	...
	public static void main(String[] args) {
		...
		if (sales >= 10000000 && sales < 30000000) bonus = 1;
		else if (sales >= 30000000 && sales < 50000000) bonus = 3;
		else if (sales >= 50000000) bonus = 5;
		...
		System.out.println("====================");
		System.out.println("총 급여 : " + (salary + (sales * bonus / 100)));
	}
